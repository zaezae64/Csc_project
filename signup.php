...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($username === "" || $password === "" || $confirm === "" || $hint_question === "" || $hint_answer === "") {
        ...
        if ($stmt->num_rows > 0) {
            ...
            $stmt->bind_param("sssssss", $username, $usertype, $status, $flair, $hashed, $hint_question, $hint_answer);
            $stmt->execute();
...
<div class="card">
    ...
    <form method="POST" action="signup.php">
        ...
        <label for="hint_question">Password Hint Question <span style="color:#e94560">*</span></label>
        <input type="text" id="hint_question" name="hint_question"
               value="<?= htmlspecialchars($_POST['hint_question'] ?? '') ?>"
               placeholder="e.g. What was the name of your first pet?" maxlength="255" required>

        <label for="hint_answer">Password Hint Answer <span style="color:#e94560">*</span></label>
        <input type="text" id="hint_answer" name="hint_answer"
               value="<?= htmlspecialchars($_POST['hint_answer'] ?? '') ?>"
               placeholder="Enter your answer" maxlength="255" required>
